...
//import 'package:flutter_app_badger/flutter_app_badger.dart'; // <-- DITAMBAH
...
class _NotifikasiPageState extends State<NotifikasiPage>
  ...
  void initState() {
    ...
    _manager.muat().then((_) {
      if (mounted) {
        setState(() {});
        _updateAppBadge(_manager.jumlahBelumDibaca); // <-- DITAMBAH
      }
    });
  }
  ...
  // ========== DITAMBAH: fungsi update badge launcher ==========
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  fontSize: 13,
                  fontWeight: FontWeight.w600,
                  color: isActive ? const Color(0xFF1BBA8A) : Colors.white,
                ),
              ),
