...
/*
══════════════════════════════════════════════════════════════════
  CARA PAKAI — tambahkan di halaman login setelah berhasil masuk:
══════════════════════════════════════════════════════════════════

  // Setelah login berhasil:
  NotifikasiApiService.authToken = responseJson['token']; // token dari Laravel
  await FcmSetup.initFcm();

══════════════════════════════════════════════════════════════════
  PUBSPEC — tambahkan dependencies ini di pubspec.yaml:
══════════════════════════════════════════════════════════════════
...
══════════════════════════════════════════════════════════════════
  SETUP FIREBASE (1x saja):
══════════════════════════════════════════════════════════════════
  1. Buat project di https://console.firebase.google.com
  2. Tambah app Android → download google-services.json
     → taruh di android/app/
  3. Jalankan: flutterfire configure
  4. Ikuti panduan: https://firebase.google.com/docs/flutter/setup
══════════════════════════════════════════════════════════════════
*/